...
#define PROTOCOL_VERSION "1.0"
	...
	#else
		#define MACHINE_NAME "Atom 2.0.7"
	#endif
...
// LCD Menu Messages
	...
	#define MSG_SETTING_ZOFFSET "Setting Z Offset"
	...
	#define MSG_GOTO_ZERO "Goto Zero"
	#define MSG_ZOFFSET "Z-Offset"
	#define MSG_AUTO_LEVEL_SPEED "AutoLvl speed"
  ...
  #define MSG_FILAMENT "Filament"
	...
	#define MSG_PAUSE_PRINT_MOVE "Pause Print Move"
	#define MSG_RESUME_PRINT "Resume Print"
	#define MSG_STOP_PRINT "Stop Print"
    #define MSG_STOP_PRINT_GO_HOME "Stop Print & Home"
	#define MSG_CARD_MENU "Print from SD"
    #define MSG_PRINT_PREVIOUS "Print prev file"
        #define MSG_PRINT_NEWEST "Print newest file"
...
// Serial Console Messages
	...
	// LCD Menu Messages
	#define WELCOME_MSG MACHINE_NAME			" ?о?ов"
	#define MSG_SD_INSERTED						"?а??а в??авлена"
	#define MSG_SD_REMOVED						"?а??а извле?ена"
	#define MSG_MAIN							" ?ен?              \003"
	#define MSG_AUTOSTART						" ?в?о??а??          "
	#define MSG_DISABLE_STEPPERS				" ??кл??и?? двига?ели"
	#define MSG_AUTO_HOME						" ?а?ковка           "
	#define MSG_SET_ORIGIN						" ?апомни?? нол?     "
	#define MSG_PREHEAT_PLA						" ??еднаг?ев PLA     "
	#define MSG_PREHEAT_PLA_SETTINGS			" ?а???. п?еднаг?.PLA"
	#define MSG_PREHEAT_ABS						" ??еднаг?ев ABS     "
	#define MSG_PREHEAT_ABS_SETTINGS			" ?а???. п?еднаг?.ABS"
	#define MSG_COOLDOWN						" ??лаждение         "
	#define MSG_SWITCH_PS_ON					"Switch Power On"
	#define MSG_SWITCH_PS_OFF					"Switch Power Off"
	#define MSG_EXTRUDE							" Эк????зи?          "
	#define MSG_RETRACT							" ??ка?"
	#define MSG_MOVE_AXIS						" ?вижение по о??м  \x7E"
	#define MSG_SPEED							" Ско?о???:"
	#define MSG_NOZZLE							" \002 Фил?е?а:"
	#define MSG_NOZZLE1							" \002 Фил?е?а2:"
	#define MSG_NOZZLE2							" \002 Фил?е?а3:"
	#define MSG_BED								" \002 ??ова??:"
	#define MSG_FAN_SPEED						" ??лле?:"
	#define MSG_FLOW							" ?о?ок:"
	#define MSG_CONTROL							" ?а???ойки \003"
	#define MSG_MIN								" \002 ?иним?м:"
	#define MSG_MAX								" \002 ?ак?им?м:"
	#define MSG_FACTOR							" \002 Фак?о?:"
	#define MSG_AUTOTEMP						" Autotemp:"
	#define MSG_ON								"?кл. "
	#define MSG_OFF								"??кл. "
	#define MSG_PID_P							" PID-P: "
	...
	#define MSG_AMAX							" Amax "
	#define MSG_A_RETRACT						" A-retract:"
	#define MSG_XSTEPS							" X ?аг/mm:"
	#define MSG_YSTEPS							" Y ?аг/mm:"
	#define MSG_ZSTEPS							" Z ?аг/mm:"
	#define MSG_ESTEPS							" E ?аг/mm:"
	#define MSG_RECTRACT    					" ??ка? пода?и      \x7E"
	#define MSG_TEMPERATURE  				" Темпе?а???а       \x7E"
	#define MSG_MOTION						" Ско?о??и          \x7E"
		#define MSG_CONTRAST "LCD contrast"
	#define MSG_STORE_EPROM						" Со??ани?? на???ойки"
	#define MSG_LOAD_EPROM						" ?аг??зи?? на???ойки"
	#define MSG_RESTORE_FAILSAFE				" Сб?о? на???оек     "
	#define MSG_REFRESH							"\004?бнови??           "
	#define MSG_WATCH							" ?бзо?             \003"
	#define MSG_PREPARE							" ?ей??ви?          \x7E"
	#define MSG_TUNE					" ?а???ойки         \x7E"
	#define MSG_PAUSE_PRINT						" ?а?за пе?а?и      \x7E"
	#define MSG_RESUME_PRINT					" ??одолжи?? пе?а?? \x7E"
	#define MSG_STOP_PRINT						" ???анови?? пе?а?? \x7E"
	#define MSG_CARD_MENU						" ?ен? ка???        \x7E"
	#define MSG_NO_CARD							" ?е? ка???"
	#define MSG_DWELL							"Сон..."
	#define MSG_USERWAIT						"?ажми?е дл? п?одолж."
	#define MSG_RESUMING "Resuming print"
	#define MSG_NO_MOVE							"?е? движени?.       "
	#define MSG_PART_RELEASE					" ?звле?ение п?ин?а  "
	#define MSG_KILLED							"У??Т?. "
	#define MSG_STOPPED							"?СТ????????. "
	#define MSG_CONTROL_RETRACT					" ??ка? mm:"
	#define MSG_CONTROL_RETRACTF				" ??ка?  F:"
	#define MSG_CONTROL_RETRACT_ZLIFT			" ???жок mm:"
	#define MSG_CONTROL_RETRACT_RECOVER			" ?озв?а? +mm:"
	#define MSG_CONTROL_RETRACT_RECOVERF		" ?озв?а?  F:"
	#define MSG_AUTORETRACT						" ?в?о??ка?:"
	#define MSG_FILAMENTCHANGE "Change filament"
	#define MSG_INIT_SDCARD "Init. SD-Card"
	#define MSG_CNG_SDCARD "Change SD-Card"
...
// Serial Console Messages
	...
	#define MSG_Enqueing						"?аплани?овано \""
	#define MSG_POWERUP							"?кл??ение пи?ани?"
	#define MSG_EXTERNAL_RESET					" ?не?ний ?б?о?"
	#define MSG_BROWNOUT_RESET					" Brown out ?б?о?"
	#define MSG_WATCHDOG_RESET					" Watchdog ?б?о?"
	#define MSG_SOFTWARE_RESET					" п?ог?аммн?й ?б?о?"
	#define MSG_MARLIN							"Marlin "
	#define MSG_AUTHOR							" | ?в?о?: "
	#define MSG_CONFIGURATION_VER				" ?о?леднее обновление: "
	#define MSG_FREE_MEMORY						" ?ам??и ?вободно: "
	#define MSG_PLANNER_BUFFER_BYTES			"  ????е? о?е?еди команд Bytes: "
	#define MSG_OK								"ok"
	#define MSG_FILE_SAVED						"Файл запи?ан."
	#define MSG_ERR_LINE_NO						"?омен ???оки ??о не по?ледн?? ???ока+1, по?ледн?? ???ока:"
	#define MSG_ERR_CHECKSUM_MISMATCH			"кон??ол?на? ??мма не ?овпадае?, по?ледн?? ???ока:"
	#define MSG_ERR_NO_CHECKSUM					"не? кон??ол?ной ??мм? дл? ???оки, по?ледн?? ???ока:"
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM	"не? ???оки дл? кон??ол?ной ??мм?, по?ледн?? ???ока:"
	#define MSG_FILE_PRINTED					"?е?а?? ?айла заве??ена"
	#define MSG_BEGIN_FILE_LIST					"Спи?ок ?айлов"
	#define MSG_END_FILE_LIST					"?оне? ?пи?ка ?айлов"
	#define MSG_M104_INVALID_EXTRUDER			"M104 о?ибка ?к????де?а "
	#define MSG_M105_INVALID_EXTRUDER			"M105 о?ибка ?к????де?а "
	#define MSG_M218_INVALID_EXTRUDER			"M218 о?ибка ?к????де?а "
	#define MSG_ERR_NO_THERMISTORS				"?е? ?е?ми???а - не? ?емпе?а????"
	#define MSG_M109_INVALID_EXTRUDER			"M109 о?ибка ?к????де?а "
	#define MSG_HEATING							"?аг?ев...  "
	#define MSG_HEATING_COMPLETE				"?а?ге?о.    "
	#define MSG_BED_HEATING						"?аг?ев ??ола...     "
	#define MSG_BED_DONE						"С?ол наг?е?.        "
	#define MSG_M115_REPORT						"FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) "\n"
	#define MSG_COUNT_X							" Count X:"
	#define MSG_ERR_KILLED						"??ин?е? о??ановлен. в?зов kill() !!"
	#define MSG_ERR_STOPPED						"??ибка п?ин?е?а, о??анов. У???ани?е неи?п?авно??? и и?пол?з?й?е M999 дл? пе?езаг??зки!. (Темпе?а???а недо???пна. ??ове???е да??ики)"
	#define MSG_RESEND							"?е?ео?п?авка:"
	#define MSG_UNKNOWN_COMMAND					"?еизве??на? команда:\""
	#define MSG_ACTIVE_EXTRUDER					"?к?ивн?й ?к????де?: "
	#define MSG_INVALID_EXTRUDER				"??ибка ?к????де?а"
	#define MSG_X_MIN							"x_min:"
	#define MSG_X_MAX							"x_max:"
	#define MSG_Y_MIN							"y_min:"
	#define MSG_Y_MAX							"y_max:"
	#define MSG_Z_MIN							"z_min:"
	#define MSG_Z_MAX							"z_max:"
	#define MSG_M119_REPORT						"С?а??? кон?евиков"
	#define MSG_ENDSTOP_HIT						"С?аба??вание кон?евика"
	#define MSG_ENDSTOP_OPEN					"?он?евик о?вобожден"
	#define MSG_HOTEND_OFFSET					"Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR				"?е о?к???? папк?"
	#define MSG_SD_INIT_FAIL					"??ибка ини?иализа?ии SD"
	#define MSG_SD_VOL_INIT_FAIL				"??ибка ини?иализа?ии ?аздела"
	#define MSG_SD_OPENROOT_FAIL				"?е п?о?е??? ?оде?жимое ко?н?"
	#define MSG_SD_CARD_OK						"SD ка??а в по??дке"
	#define MSG_SD_WORKDIR_FAIL					"не о?к???? ?або??? папк?"
	#define MSG_SD_OPEN_FILE_FAIL				"??ибка ??ени?, ?айл: "
	#define MSG_SD_FILE_OPENED					"Файл о?к???:"
	#define MSG_SD_SIZE							" ?азме?:"
	#define MSG_SD_FILE_SELECTED				"Файл в?б?ан"
	#define MSG_SD_WRITE_TO_FILE				"?апи?? в ?айл: "
	#define MSG_SD_PRINTING_BYTE				"SD пе?а?? byte "
	#define MSG_SD_NOT_PRINTING					"не? SD пе?а?и"
	#define MSG_SD_ERR_WRITE_TO_FILE			"о?ибка запи?и в ?айл"
	#define MSG_SD_CANT_ENTER_SUBDIR			"?е зай?и в папк?:"
	#define MSG_STEPPER_TOO_HIGH				"Ча??о?а ?агов о?ен? в??ока : "
	#define MSG_ENDSTOPS_HIT					"кон?евик ??або?ал: "
	#define MSG_ERR_COLD_EXTRUDE_STOP			" за?и?а ?олодной ?к????зии"
	#define MSG_ERR_LONG_EXTRUDE_STOP			" за?и?а п?ев??ени? длинн? ?к????зии"
